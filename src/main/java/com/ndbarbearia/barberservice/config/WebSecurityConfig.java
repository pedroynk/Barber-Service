...
import com.ndbarbearia.barberservice.service.UserDetailsServiceImpl;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        .authorizeHttpRequests(authorizeRequests -> authorizeRequests
            ...
            .hasAuthority(Profile.ADMINISTRADOR.toString())  // Apenas administradores podem acessar essas rotas
            ...
            .rememberMe(rememberMe -> rememberMe
                .key("chaverememberMe")
                .userDetailsService(userDetailsServiceImpl)  // Serviço de usuários para RememberMe
            );
